...
import { teamMembers, teamPageCopy } from "@/content/team";

export const metadata: Metadata = {
  title: "Our Team",
  description:
    "Meet the senior consultants behind Apex Cloud Consulting — automotive cloud architects, SAP specialists, connected car engineers, and security experts.",
  keywords: [
    "automotive cloud consultants",
    "SAP automotive experts",
    "connected car architects",
    "TISAX consultants",
    "cloud migration automotive team",
  ],
  alternates: { canonical: "/team" },
  openGraph: {
    title: "Our Team | Apex Cloud Consulting",
    description:
      "Meet the senior consultants behind Apex Cloud Consulting — automotive cloud architects, SAP specialists, and security experts.",
    url: "/team",
    type: "website",
  },
};
...
const teamSchema = {
  ...
  description: teamPageCopy.subheadline,
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-gray-900 to-blue-950 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          <h1 className="text-4xl sm:text-5xl font-bold mb-6">{teamPageCopy.headline}</h1>
          <p className="text-lg text-blue-100 leading-relaxed">{teamPageCopy.subheadline}</p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {teamMembers.map((member) => (
              ...
              >
                ...
                <p className="text-gray-600 leading-relaxed text-sm mb-6">{member.bio}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              { value: "200+", label: "Migrations Delivered" },
              { value: "8", label: "Years in Automotive Cloud" },
              { value: "4", label: "Hyperscaler Partnerships" },
            ].map((stat) => (
              <div key={stat.label}>
      ...
      <section className="bg-blue-600 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-blue-100 text-lg mb-8">
            Senior consultants. No junior handoffs. Your engagement is led by an experienced architect from day one.
          </p>
          <Link
            href="/contact"
      ...
      <div className="bg-gray-50 py-4 text-center">
        <p className="text-xs text-gray-400">
          Last updated:{" "}
          {new Date(teamPageCopy.updatedAt).toLocaleDateString("en-GB", {
            day: "numeric",
            month: "long",
            year: "numeric",
          })}
