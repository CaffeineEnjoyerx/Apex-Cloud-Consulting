        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-36">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <Link
                href={heroCopy.cta.primary.href}
              ...
              >
                {heroCopy.cta.primary.label}
              </Link>
              <Link
                href={heroCopy.cta.secondary.href}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              End-to-End Cloud Expertise for Automotive
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              From migration to connected car platforms — we cover every layer of your cloud journey.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Zero-downtime migrations for 24/7 manufacturing environments.",
                path: "M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z",
              },
              {
                title: "DevOps & CI/CD",
                desc: "Automated pipelines for embedded and cloud-native software.",
              ...
              },
              {
                ...
                desc: "Real-time telematics and scalable data lakehouse platforms.",
              ...
              {
                title: "Connected Car",
                desc: "OTA update backends and vehicle-to-cloud data pipelines.",
              ...
              {
                title: "SAP on Cloud",
                desc: "S/4HANA migrations with zero business downtime.",
              ...
              },
              {
                ...
                desc: "TISAX readiness and UNECE WP.29 cybersecurity frameworks.",
